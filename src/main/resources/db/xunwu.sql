...
CREATE TABLE `action`  (
  ...
  `action_info` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- Records of action
-- ----------------------------
INSERT INTO `action` VALUES (1, '/permission/testMock', '测试mock数据', '2019-10-12 10:44:38', '2019-10-12 10:44:40');
INSERT INTO `action` VALUES (2, '/permission/testPrint', '打印信息', '2019-10-12 10:46:33', '2019-10-12 10:46:36');
...
CREATE TABLE `house`  (
  ...
  `cover` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '封面',
  ...
  `bathroom` int(11) NULL DEFAULT 0,
  `street` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '街道',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 27 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '房屋信息表' ROW_FORMAT = Compact;
...
INSERT INTO `house` VALUES (24, '湖光壹号望京华府183-387㎡阔景大宅', 50000, 288, 5, 1, 1, 0, 2015, 3, '2017-09-07 11:42:20', '2017-12-03 11:13:10', 'bj', 'hdq', 'FvVqU8LneZZ5xaLBAOM1KXR2Pz1X', 5, 200, 3, '融泽嘉园', 2, 0, '龙域西二路');
...
INSERT INTO `house` VALUES (26, 'this is a title', 12000, 100, 2, 2, 2, NULL, 2018, 1, '2019-11-09 17:59:05', '2019-11-09 17:59:05', 'bj', 'dcq', 'group1/M00/00/03/wKgLiV3GjdeATU1XAAFSLLN0ntQ983.jpg', 3, 200, 1, 'test', 1, NULL, 'test street');
...
INSERT INTO `house_detail` VALUES (33, 'sadsdasdas', '123', '123', '123', 1, 'test', 1, '13号线', 16, '东直门', 26);
...
CREATE TABLE `house_picture`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 87 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '房屋图片信息' ROW_FORMAT = Compact;
...
INSERT INTO `house_picture` VALUES (86, 26, 'http://192.168.11.137/', 256, 120, NULL, 'group1/M00/00/03/wKgLiV3GjdeATU1XAAFSLLN0ntQ983.jpg');
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '预约看房信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of house_subscribe
-- ----------------------------
INSERT INTO `house_subscribe` VALUES (9, 26, 1, NULL, 3, '2017-11-26 11:06:23', '2017-12-02 09:21:01', '2017-12-03 00:00:00', '13888888888', 2);
...
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '房屋标签映射关系表' ROW_FORMAT = Compact;
...
INSERT INTO `house_tag` VALUES (26, 22, '独立卫生间');
INSERT INTO `house_tag` VALUES (26, 23, '空调');
INSERT INTO `house_tag` VALUES (26, 24, '精装修');
...
CREATE TABLE `permission`  (
  ...
  `code` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '权限标识,如: systemmange:user:page',
...
-- ----------------------------
INSERT INTO `permission` VALUES (1, 'role:admin', '管理员权限', 1);
INSERT INTO `permission` VALUES (2, 'role:operator', '运维权限', 1);
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES (1, 'admin', '管理员', '2019-10-12 10:29:02', '2019-10-12 10:29:06');
INSERT INTO `role` VALUES (2, 'operator', '运维', '2019-10-12 10:30:04', '2019-10-12 10:31:57');
INSERT INTO `role` VALUES (3, 'tem_user', '临时用户', '2019-10-12 10:31:52', '2019-10-12 10:31:55');
...
CREATE TABLE `sys_role_action`  (
  ...
  `role_action_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'l用户对于的权限url',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `sys_role_action` VALUES (2, '1', '2');
INSERT INTO `sys_role_action` VALUES (3, '2', '1');
INSERT INTO `sys_role_action` VALUES (4, '2', '2');
INSERT INTO `sys_role_action` VALUES (5, '3', '1');
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色权限关联表' ROW_FORMAT = Compact;
...
CREATE TABLE `user`  (
  ...
  `create_time` datetime NOT NULL DEFAULT '2017-11-25 17:56:45',
  `last_login_time` datetime NOT NULL DEFAULT '2017-11-25 17:56:45',
  `last_update_time` datetime NOT NULL DEFAULT '2017-11-25 17:56:45',
  `avatar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `index_on_phone`(`phone_number`) USING BTREE,
  UNIQUE INDEX `index_on_username`(`name`) USING BTREE,
  UNIQUE INDEX `index_on_email`(`email`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', 'admin@123.com', '15111111111', '448da7d4bf06cc984bfcdd891445971b', 1, '2017-08-25 15:18:20', '2017-08-25 12:00:00', '2017-11-26 10:29:02', 'http://7xo6gy.com1.z0.glb.clouddn.com/99ff568bd61c744bf31185aeddf13580.png');
INSERT INTO `user` VALUES (2, 'tony', 'tony@123.com', '1388888888', '88b29635eb2ee6c56eec227c5c6023e9', 1, '2017-08-27 09:07:05', '2017-08-27 09:07:07', '2017-10-21 15:03:57', 'http://7xo6gy.com1.z0.glb.clouddn.com/99ff568bd61c744bf31185aeddf13580.png');
